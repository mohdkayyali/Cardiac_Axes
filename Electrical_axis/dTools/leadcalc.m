...
% the Kors matrix for lead synthesis.
%
...
%----------------------------------------------------------------------------
% synthesised VCG with Kors matrix
elseif strcmp(type,'kors')
	t = [-.13 .05 -.01 .14 .06 .54 .38  -.07;...
		  .06 -.02 -.05 .06 -.17 .13 -.07 .93;...
	     -.43 -.06 -.14 -.20 -.11 .31 .11 -.23]; 
	y = t * x(1:8,:);
